module github.com/rmonier/terraform-provider-nvkind
...
require (
	github.com/NVIDIA/nvkind v0.0.0-20250528082612-b52126989300
...
require (
	...
	github.com/NVIDIA/go-nvlib v0.2.0 // indirect
